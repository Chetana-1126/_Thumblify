                    ...
                    <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea value={additionalDetails} onChange={(e) =>
                                setAdditionalDetails(e.target.value)} rows={3} placeholder="Add any specific elements, mood, or style preferences..." className="w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none"/>
                        </div>
                        ...
                        {/*BUTTON*/}
                        {!id && (
                            <button onClick={handleGenerate} className="text-[15px] w-full py-3.5 round-xl font-medium bg-linear-to-b from-pink-500 to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed transition-colors">
